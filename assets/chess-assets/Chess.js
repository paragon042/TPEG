    ...
    document.querySelectorAll('.box').forEach(image => {
        ...
        if (image.innerText.length !== 0) {
            if (image.innerText == 'Wpawn' || image.innerText == 'Bpawn') {
                image.innerHTML = `${image.innerText} <img class='allimg allpawn' src="assets/chess-assets/${image.innerText}.png" alt="">`
                ...
                image.innerHTML = `${image.innerText} <img class='allimg' src="assets/chess-assets/${image.innerText}.png" alt="">`
                image.style.cursor = 'pointer'
            }
        }
    })
